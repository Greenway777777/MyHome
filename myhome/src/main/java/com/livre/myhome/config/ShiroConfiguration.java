...
import com.livre.myhome.filter.URLPathMatchingFilter;
import com.livre.myhome.realm.MyRealm;
...
public class ShiroConfiguration {
    ...
    public MyRealm getMyRealm() {
        ...
        myRealm.setCredentialsMatcher(hashedCredentialsMatcher()); // doCredentialsMatch对salt和pwd进行hash 比较
        return myRealm;
    }
    ...
    public SimpleCookie rememberMeCookie() {
        ...
        simpleCookie.setMaxAge(36000); // 存活秒数
        return simpleCookie;
    }
